...
var valorant = DataSerie<ValorantMatch>.FromCsv(@".\data\valorant.csv", ParseValorant);
var cs2 = DataSerie<Cs2Match>.FromCsv(@".\data\cs2.csv", ParseCS2);
var lol = DataSerie<LolMatch>.FromCsv(@".\data\Lol.csv", ParseLoL);
